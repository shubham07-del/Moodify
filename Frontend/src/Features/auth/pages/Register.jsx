...
import { Eye, EyeOff, ArrowRight, Lock, Mail, UserCheck } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-[#141310] flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-2 mb-10 justify-center">
          ...
          <span className="text-[#f2ede4] font-semibold tracking-tight text-lg">Moodify</span>
        </div>
 
        <div className="bg-[#1c1a16] border border-[#2c2822] rounded-2xl p-8 shadow-2xl shadow-black/40">
          <h1 className="text-2xl font-semibold text-[#f2ede4] tracking-tight mb-3 text-center">Register</h1>
 
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            {/* Username */}
            <div>
              <label htmlFor="username" className="block text-xs font-medium text-[#a39c8c] mb-1.5 uppercase tracking-wide">
                Username
              </label>
              <div className="relative">
                <UserCheck className="w-4 h-4 text-[#6b6558] absolute left-3.5 top-1/2 -translate-y-1/2" />
                <input
                  id="username"
                  type="text"
                  value={username}
            ...
            {/* Email */}
            <div>
              <label htmlFor="email" className="block text-xs font-medium text-[#a39c8c] mb-1.5 uppercase tracking-wide">
                Email
              </label>
              <div className="relative">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label htmlFor="password" className="block text-xs font-medium text-[#a39c8c] uppercase tracking-wide">
                  Password
                </label>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-sm text-[#6b6558] mt-6">
          Already have an account?{" "}
           <Link className="text-md text-white/80 underline" to="/login">Login</Link>
        </p>
      </div>
    </div>
  );
